...
<div class="grid-item <?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <a href="<?php print image_style_url($style_large, $img_url) ?>" rel="lightbox[group]">
   <img src="<?php print image_style_url($style, $img_url) ?>">
  </a>

  <div class="rollover-desc-wrap">
      <div class="rollover-desc">
